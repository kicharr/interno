<template>
  ...
  <main class="main__wrapper">
    ...
    <section class="info-block__wrapper container">
      <div class="info-block__row">
        <div class="info-card">
          ...
          <div class="info-link__wrapper">
            <router-link to="/services/project-plan" class="info-link">
              Read More
    ...
    <section class="working__wrapper">
      <div class="working-content__wrapper container">
        <div class="title-center__wrapper">
          <h2>
            How We Work
          </h2>
          <p class="title-center__description">
            It is a long established fact will be distracted.Lorem Ipsum is simply dummy text of <br> the printing and
            typesetting industry.
          </p>
        </div>


        <div class="working-rows__wrapper">
          <div class="working-row">

            <div class="working-preview__wrapper">
              <img src="../assets/services/working-1.png" alt="Working image">
            </div>

            <div class="working-card-content__wrapper">
              ...
              <p class="working-card__title">
                Concept & Details
              </p>
              <p class="working-card__description">
          ...
          <div class="working-row working-row__reverse">

            <div class="working-preview__wrapper working-preview__wrapper-reverse">
              <img src="../assets/services/working-2.png" alt="Working image">
            </div>
          ...
          <div class="working-row">
            ...
            <div class="working-preview__wrapper">
              <img src="../assets/services/working-3.png" alt="Working image">
            </div>
          ...
          <div class="working-row working-row__reverse">
            ...
            <div class="working-preview__wrapper working-preview__wrapper-reverse">
              <img src="../assets/services/working-4.png" alt="Working image">
            </div>
...
export default {
  name: "ServicesPage",
  components: {PageFirstBlock, ContactFormFooter, MainHeaderComponent, MainFooterComponent},
  data() {
    return {
      pageTitle: 'Services'
    }
...
<style scoped>
.first-block-wrapper {
  background-image: url("../assets/services/main-bg.jpg");
...
.working-preview__wrapper {
  margin-right: 2.32rem;
}

.working-content__wrapper {
  border-radius: 3.18182rem;
  background: #F4F0EC;
  padding: 7.27273rem 5.27273rem;
}
...
.working-row__reverse {
  flex-direction: row-reverse;
}

.working-preview__wrapper-reverse {
  margin-right: 0;
  margin-left: 2.68rem;
}
...
@media (max-width: 1024px) {
  ...
  .working-preview__wrapper img {
    max-width: 15rem;
  }

  .working-preview__wrapper-reverse[data-v-c91f6bfc] {
    margin-right: 0;
    margin-left: 0
  }
